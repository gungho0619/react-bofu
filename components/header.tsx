...
import DiscordIcon from "./assets/image/logo-discord.svg";
import TelegramIcon from "./assets/image/telegram-black-icon.svg";
...
export const Header = () => {
  ...
  return (
    <Wrapper>
      <WrapperContent>
        <LogoTitle>Home.Story.Comiconomics.utility</LogoTitle>
        <LogoSecTitle>Home.Story.Utility</LogoSecTitle>
        <SocialGroup>
          <SocialIcon src={DiscordIcon.src} />
          <SocialIcon src={TelegramIcon.src} />
        </SocialGroup>
        {/* <Link href="/home">
